...
class land_Elementor_Addon_About_Text extends Widget_Base {
    ...
    public function get_name() {
        return 'land-about-text';
    }

    public function get_title() {
        return esc_html__( 'About Text', 'land' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'       =>  esc_html__( 'Heading About Text', 'land' ),
                'label_block'   =>  true
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   =>  esc_html__( 'Default description', 'land' ),
            ]
        );
        ...
        $this->add_control(
            'align',
            [
                'label'     =>  esc_html__( 'Alignment Title', 'land' ),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Typography', 'land' ),
