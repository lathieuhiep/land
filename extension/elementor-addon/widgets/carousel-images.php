...
class Land_Elementor_Addon_Carousel_Images extends Widget_Base {
	...
	public function get_name() {
		return 'land-carousel-images';
	}

	public function get_title() {
		return esc_html__( 'Carousel Images', 'land' );
	}
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			'list_title', [
				...
				'default' => esc_html__( 'Title #1' , 'land' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'list_title' => __( 'Title #1', 'land' ),
					],
					[
						'list_title' => __( 'Title #2', 'land' ),
					],
                    [
                        'list_title' => __( 'Title #3', 'land' ),
                    ],
                    [
                        'list_title' => __( 'Title #4', 'land' ),
                    ],
				],
		...
		$this->add_control(
			'margin_item',
			[
				'label'   => esc_html__( 'Space Between Item', 'land' ),
		...
		$this->add_control(
			'min_width_1200',
			[
				'label'     => esc_html__( 'Min Width 1200px', 'land' ),
		...
		$this->add_control(
			'item',
			[
				'label'   => esc_html__( 'Number of Item', 'land' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 4,
				'min'     => 1,
				'max'     => 100,
		...
		$this->add_control(
			'min_width_992',
			[
				'label'     => esc_html__( 'Min Width 992px', 'land' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'min_width_768',
			[
				'label'     => esc_html__( 'Min Width 768px', 'land' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'min_width_568',
			[
				'label'     => esc_html__( 'Min Width 568px', 'land' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'max_width_567',
			[
				'label'     => esc_html__( 'Max Width 567px', 'land' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
