...
class Land_Elementor_Addon_Info_Box extends Widget_Base {
	...
	public function get_name(): string {
		return 'land-info-box';
	}

	public function get_title(): string {
		return esc_html__( 'Info box', 'land' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'img_type',
			[
				'label' => esc_html__('Infobox Type', 'land'),
				'type' => Controls_Manager::SELECT,
				'default' => 'img-on-top',
				'label_block' => false,
				'options' => [
					'img-on-top' => esc_html__('Image/Icon On Top', 'land'),
					'img-on-left' => esc_html__('Image/Icon On Left', 'land'),
					'img-on-right' => esc_html__('Image/Icon On Right', 'land'),
				],
			]
		);
		...
		$this->add_control(
			'img_or_icon',
			[
				'label' => esc_html__('Image or Icon', 'land'),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => true,
				'options' => [
					'none' => [
						'title' => esc_html__('None', 'land'),
						'icon' => 'fa fa-ban',
					],
					
					'icon' => [
						'title' => esc_html__('Icon', 'land'),
						'icon' => 'fa fa-info-circle',
					],
					
					'img' => [
						'title' => esc_html__('Image', 'land'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Icon Position', 'land'),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'top',
				'condition' => [
					'img_type!' => 'img-on-top',
		...
		$this->add_control(
			'selected_image',
			[
				'label' => esc_html__('Infobox Image', 'land'),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => esc_html__('This is an icon box', 'land'),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'rows' => 10,
				'default' => esc_html__('Write a short description, that will describe the title or something informational and useful.', 'land'),
		...
		$this->add_control(
			'show_description',
			[
				'label' => esc_html__('Show Description', 'land'),
		...
		$this->add_responsive_control(
			'content_alignment',
			[
				'label' => esc_html__('Content Alignment', 'land'),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => true,
				'options' => [
					'left' => [
		...
		$this->add_responsive_control(
			'icon_size',
			[
				'label' => esc_html__('Icon Size', 'land'),
		...
		$this->add_control(
			'icon_color',
			[
				'label' => esc_html__('Icon Color', 'land'),
